...
Telegram-бот для арбітражної команди, який відповідає на питання з внутрішньої `.md`-документації за допомогою RAG (Retrieval-Augmented Generation). Включає веб-адмінпанель для моніторингу, управління документами та контролю доступу користувачів.
